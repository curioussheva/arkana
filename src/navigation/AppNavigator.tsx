...
import { PersonalYearScreen } from '@screens/PersonalYearScreen';
...
import DBManagerScreen from '@screens/DBManagerScreen';

// ⚡ IMPOR SCREEN DEBUG
import { MatrixDebugInspector } from '@components/debug/MatrixDebugInspector';
...
export type RootDrawerParamList = {
  ...
  About: undefined;
  DBManager: undefined;
  MatrixDebug: undefined; // 👈 Registrasi Tipe Debug
};
...
function TabIcon({ icon, focused, color }: { icon: string; focused: boolean; color: string }) {
  ...
  return (
    <Animated.View
      style={[styles.tabIcon, focused && { backgroundColor: color + '20' }, animatedStyle]}
    >
  ...
  return (
    <Tab.Navigator
      screenOptions={({ route }) => ({
        ...
        tabBarStyle: {
          backgroundColor: colors.backgroundLight + 'E6',
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.backgroundLight }}>
      <View
        style={[
          styles.drawerHeader,
          { paddingTop: insets.top + 24, borderBottomColor: colors.border },
        ]}
      >
...
function DrawerWrapper() {
  ...
  return (
    ...
    >
      ...
      <Drawer.Screen
        name="DBManager"
        component={DBManagerScreen}
        options={{
          drawerLabel: 'Database',
          drawerIcon: ({ color }) => <Text style={{ fontSize: 18, color }}>🗄️</Text>,
        }}
      />
      {/* ⚡ SCREEN DEBUG MATRIX INSPECTOR */}
      <Drawer.Screen
        name="MatrixDebug"
        component={MatrixDebugInspector}
        options={{
          drawerLabel: 'Matrix Inspector',
          drawerIcon: ({ color }) => <Text style={{ fontSize: 18, color }}>⚡</Text>,
        }}
      />
    </Drawer.Navigator>
