        ...
        <View style={[styles.modalContent, { backgroundColor: colors.surface, borderColor: colors.border }]}>
          ...
          <ScrollView style={styles.modalList} showsVerticalScrollIndicator={false}>
            <TouchableOpacity
              style={[
                styles.profileItem, 
                !selectedId && { backgroundColor: colors.primary + '15', borderColor: colors.primary + '30' }, 
            ...
            {profiles.map(profile => (
              <TouchableOpacity
                ...
                style={[
                  styles.profileItem, 
                  selectedId === profile.id && { backgroundColor: colors.primary + '15', borderColor: colors.primary + '30' }, 
                  { borderColor: colors.border }
                ]}
              ...
              >
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={{ color: colors.textSecondary, fontSize: FONT_SIZE.xs }}>{profile.birthDate}</Text>
                </View>
          ...
          <TouchableOpacity style={[styles.modalCloseButton, { backgroundColor: colors.backgroundLight }]} onPress={onClose}>
...
const styles = StyleSheet.create({
  ...
  profileItem: { flexDirection: 'row', alignItems: 'center', padding: SPACING.md, borderRadius: BORDER_RADIUS.xl, marginBottom: SPACING.sm, borderWidth: 1 },
