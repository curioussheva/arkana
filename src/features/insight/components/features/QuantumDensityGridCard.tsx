  ...
  return (
    ...
    >
      ...
      <View>
        ...
        <Text style={[styles.subtitle, { color: colors.textSecondary }]}>Keseimbangan Elemen & Nilai</Text>
      </View>
      ...
      {stats ? (
        <View style={styles.statsContainer}>
          <View style={styles.statRow}>
            <Text style={[styles.statItemLabel, { color: colors.textSecondary }]}>Elemen Dominan</Text>
          ...
          <View style={styles.statRow}>
            <Text style={[styles.statItemLabel, { color: colors.textSecondary }]}>Rataan Getaran</Text>
