...
const KOSMIK_METADATA: Record<
  number,
  { planet: string; elemen: string; warna: string[]; tema: string }
> = {
  ...
  3: {
    ...
    elemen: 'Udara',
    warna: ['#ec4899', '#f43f5e'],
    tema: 'Ekspresi & Manifestasi',
  },
  4: {
    planet: 'Kaisar',
    elemen: 'Bumi',
    warna: ['#10b981', '#047857'],
    tema: 'Stabilitas & Otoritas',
  },
  5: {
    planet: 'Merkurius',
    elemen: 'Udara',
    warna: ['#a855f7', '#6b21a8'],
    tema: 'Kebebasan & Komunikasi',
  },
  6: {
    planet: 'Venus',
    elemen: 'Air/Bumi',
  ...
  7: {
    ...
    elemen: 'Air',
    warna: ['#06b6d4', '#0891b2'],
    tema: 'Introspeksi & Kebijaksanaan',
  },
  8: {
    planet: 'Saturnus',
    elemen: 'Bumi',
    warna: ['#4b5563', '#1f2937'],
    tema: 'Kekuatan & Keadilan',
  },
  9: {
    planet: 'Pertapa',
    elemen: 'Bumi',
    warna: ['#78350f', '#451a03'],
    tema: 'Penyelesaian & Transendensi',
  },
  ...
  10: {
    ...
    elemen: '🔥 Api',
    warna: ['#ffd700', '#a855f7'],
    tema: 'Roda Takdir & Keberuntungan',
  },
  11: {
    planet: 'Kekuatan',
    elemen: 'Api',
    warna: ['#b91c1c', '#7f1d1d'],
    tema: 'Potensi Spiritual',
  },
  12: {
    planet: 'Neptunus',
    elemen: 'Air',
    warna: ['#60a5fa', '#2563eb'],
    tema: 'Perspektif Terbalik',
  },
  13: {
    planet: 'Transformasi',
    elemen: 'Air',
    warna: ['#374151', '#111827'],
    tema: 'Metamorfosis Jiwa',
  },
  14: {
    planet: 'Suhu',
    elemen: 'Udara',
    warna: ['#34d399', '#059669'],
    tema: 'Alkimia Keseimbangan',
  },
  15: {
    planet: 'Pluto',
    elemen: 'Api',
    warna: ['#1e1b4b', '#311042'],
    tema: 'Pembebasan Bayangan',
  },
  16: {
    planet: 'Mars',
    elemen: 'Api',
    warna: ['#dc2626', '#991b1b'],
    tema: 'Dinamika Rekonstruksi',
  },
  ...
  18: {
    ...
    elemen: 'Air',
    warna: ['#1e293b', '#0f172a'],
    tema: 'Eksplorasi Alam Bawah Sadar',
  },
  19: {
    planet: 'Matahari Puncak',
    elemen: 'Api',
    warna: ['#fcf300', '#f97316'],
    tema: 'Vitalitas Kelimpahan',
  },
  20: {
    planet: 'Pluto Gema',
    elemen: 'Bumi',
    warna: ['#c084fc', '#581c87'],
    tema: 'Kelahiran Kembali Keluarga',
  },
  21: {
    planet: 'Semesta',
    elemen: 'Udara/Air',
    warna: ['#10b981', '#3b82f6'],
    tema: 'Harmoni Universal Sempurna',
  },
  22: {
    planet: 'Uranus',
    elemen: 'Udara',
    warna: ['#f43f5e', '#f59e0b'],
    tema: 'Kebebasan Tanpa Batas',
  },
};
...
export function PersonalYearScreen() {
  ...
  const cosmicMeta = KOSMIK_METADATA[displayArcanaId] || {
    planet: 'Universal',
    elemen: 'Murni',
    warna: ['#a855f7', '#3b82f6'],
    tema: 'Evolusi',
    ...
    >
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <Animated.View entering={FadeInDown.duration(400)}>
          <LinearGradient
            colors={cosmicMeta.warna as [string, string, ...string[]]}
            style={styles.header}
          >
        ...
        >
          ...
          <View style={styles.gaugeGrid}>
            <View style={[styles.gaugeItem, { backgroundColor: colors.backgroundLight }]}>
              ...
              <Text style={[styles.gaugeVal, { color: cosmicMeta.warna[0] }]}>
                {cosmicMeta.planet}
              </Text>
            </View>
            ...
            <View style={[styles.gaugeItem, { backgroundColor: colors.backgroundLight }]}>
              ...
              <Text style={[styles.gaugeVal, { color: cosmicMeta.warna[1] || colors.primary }]}>
                {cosmicMeta.elemen}
              </Text>
            </View>
          </View>
          ...
          <View style={[styles.temaBadge, { backgroundColor: cosmicMeta.warna[0] + '15' }]}>
            <Text style={[styles.temaText, { color: cosmicMeta.warna[0] }]}>
              FOCUS METRIC: {cosmicMeta.tema}
            </Text>
          </View>
        </Animated.View>
        ...
        >
          <Text style={[styles.interpretationTitle, { color: colors.primary }]}>
            ✨ Cetak Biru Siklus
          </Text>
